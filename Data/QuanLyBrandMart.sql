...
VALUES(700001, 200001, 600001, 300001, TO_DATE('01/07/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700002, 200002, 600001, 300001, TO_DATE('01/07/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700003, 200002, 600001, 300001, TO_DATE('01/07/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700004, 200002, 600001, 300002, TO_DATE('01/07/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700005, 200003, 600002, 300001, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700006, 200004, 600002, 300004, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700007, 200004, 600002, 300003, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700008, 200005, 600001, 300003, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700009, 200006, 600001, 300005, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700010, 200008, 600001, 300005, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700011, 200009, 600001, 300006, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700012, 200009, 600002, 300008, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700013, 200010, 600002, 300009, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700014, 200011, 600001, 300010, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
INSERT INTO BILL(BILL_ID, EMP_ID, CASHIER_COUNTER_ID, STUDENT_ID, BILL_DATE, TOTAL_MONEY)
VALUES(700015, 200013, 600001, 300007, TO_DATE('01/08/2022', 'dd/mm/yyyy'), 0);
...
--TRIGGER
--1 USER LOGIN CO TOI DA 1 NGUOI SU DUNG
CREATE OR REPLACE TRIGGER TRIGGER_USER_LOGIN
BEFORE INSERT OR UPDATE OF EMP_LOGIN_ID ON EMPLOYEE
FOR EACH ROW
DECLARE 
    NUM_USER_OF_LOGIN_ID NUMBER;
    LOGIN_ID USER_LOGIN.USER_LOGIN_ID%TYPE;
BEGIN
    SELECT COUNT(EMP_ID),:NEW.EMP_LOGIN_ID INTO NUM_USER_OF_LOGIN_ID, LOGIN_ID
    FROM EMPLOYEE
    WHERE EMP_LOGIN_ID = :NEW.EMP_LOGIN_ID;
    
    IF (NUM_USER_OF_LOGIN_ID > 0) THEN
        RAISE_APPLICATION_ERROR(-20122,'EMP_LOGIN_ID: '||LOGIN_ID ||' DA DUOC SU DUNG');
        COMMIT;
    END IF;
END;
/
INSERT INTO EMPLOYEE (EMP_ID, FIRST_NAME, LAST_NAME, GENDER, BIRTHDAY, PHONE, ADDRESS, START_DATE, SALARY, EMP_LOGIN_ID, ROLE)
VALUES (200011,'Nguyen Thi My', 'Tran','Female', TO_DATE('05/05/2002', 'dd/mm/yyyy'), '0921231741', 'KTX khu B', TO_DATE('21/02/2022', 'dd/mm/yyyy'), 10000000,100001,'Manager');
UPDATE EMPLOYEE
SET EMP_LOGIN_ID =100011
WHERE EMP_ID=200001;
