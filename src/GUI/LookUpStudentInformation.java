...
public class LookUpStudentInformation extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LookUpStudentInformation
     */
    public LookUpStudentInformation() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LookUpStudentInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LookUpStudentInformation().setVisible(true);
            }
        });
    }
