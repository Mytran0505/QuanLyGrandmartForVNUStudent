...
public class DeleteEmpForm extends javax.swing.JFrame {
    ...
    public DeleteEmpForm(Employee_DTO manager) {
        initComponents();
        dtoManager = manager;
        setResizable(false);
    ...
    public void createTable(){
        ...
        tblSearch.getSelectionModel().addListSelectionListener((ListSelectionEvent e) -> {
            if(tblSearch.getSelectedRow() >= 0){
                ...
                setVisible(false);
                new DeleteEmp2(dtoEmployee).setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 810, 380));
