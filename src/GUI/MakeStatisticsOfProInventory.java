...
public class MakeStatisticsOfProInventory extends javax.swing.JFrame {
    ...
    public MakeStatisticsOfProInventory(Employee_DTO storekeeper) {
        initComponents();
    ...
    private void btn_EachProActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EachProActionPerformed
        // TODO add your handling code here:
        ProInventory_Each pro = new ProInventory_Each(dtoStorekeeper);
        pro.setVisible(true);
        setVisible(false);
    ...
    private void btn_AllProActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AllProActionPerformed
        // TODO add your handling code here:
        ProInventory_All pro = new ProInventory_All(dtoStorekeeper);
        pro.setVisible(true);
        setVisible(false);
