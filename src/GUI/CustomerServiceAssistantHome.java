...
public class CustomerServiceAssistantHome extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CustomerServiceAssistantHome
     */
    public CustomerServiceAssistantHome() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerServiceAssistantHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerServiceAssistantHome().setVisible(true);
            }
        });
    }
