...
public class ProInventory_Each extends javax.swing.JFrame {
    ...
    public ProInventory_Each(Employee_DTO storekeeper) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtProID, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 60, 230, 30));
    ...
    private void btn_MakeStatisticsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_MakeStatisticsActionPerformed
        ...
        if(txtProID.getText().equals("")||!txtProID.getText().matches("[0-9]*"))
            ...
            for(int i = 0; i < list.size(); i++){
                ...
                String[] rows = {String.valueOf(dtoStatistics.getPro_id()),dtoStatistics.getName(),dtoStatistics.getImported_date().toString(),String.valueOf(dtoStatistics.getRemaining_quantity())}; 
                tblProductModel.addRow(rows);
            }
            if(tblProductModel.getRowCount() < 1){
