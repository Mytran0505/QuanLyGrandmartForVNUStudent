...
public class InsertPro2 extends javax.swing.JFrame {
    ...
    Product_DTO newProduct = null;
    
    public InsertPro2(Product_DTO product){
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel9.add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 200, 30));
        ...
        jPanel9.add(txtCountry, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 200, 30));
        ...
        jPanel9.add(txtSPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 200, 200, 30));
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        if(busProductManagement.insert(newProduct)){
            JOptionPane.showMessageDialog(this, "Product information is inserted successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            setVisible(false);
            InsertProForm insertForm = new InsertProForm(newProduct);
