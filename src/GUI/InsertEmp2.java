...
public class InsertEmp2 extends javax.swing.JFrame {
    ...
    public InsertEmp2(Employee_DTO employee) {
        initComponents();
        newEmployee = busEmployeeManagement.getEmployeeInfo(employee);
        setResizable(false);
        setLocationRelativeTo(null);
        txtEmpLoginID.setText(String.valueOf(newEmployee.getEmp_id()));
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, 662, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel7.add(txtFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 200, 30));
        ...
        jPanel7.add(txtBirthday, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 200, 200, 30));
        ...
        jPanel7.add(txtPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 240, 200, 30));
        ...
        jPanel7.add(txtLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 200, 30));
        ...
        jPanel7.add(txtGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 160, 200, 30));
    ...
    private void btnDismissActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDismissActionPerformed
        ...
        setVisible(false);
        InsertEmpForm insertForm = new InsertEmpForm(newEmployee);
