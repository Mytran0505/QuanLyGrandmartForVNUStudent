...
public class UpdateStudent1 extends javax.swing.JFrame {
    ...
    public UpdateStudent1(Student_DTO newstudent) {
        initComponents();
    ...
    public void createTable(){
        ...
        tblSearch.getSelectionModel().addListSelectionListener((ListSelectionEvent e) -> {
            if(tblSearch.getSelectedRow() >= 0){
                ...
                setVisible(false);
                new UpdateStu2(dtoStudent2).setVisible(true);
            }
        });
    ...
    private void initComponents() {
        ...
        tblSearch.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "First Name", "Last Name", "Gender", "Address", "Phone", "Birthday", "School name", "Registration date", "Spent money", "Point"
            }
        ));
