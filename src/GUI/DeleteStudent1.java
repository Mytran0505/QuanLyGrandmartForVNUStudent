...
public class DeleteStudent1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DeleteStudent1
     */
    public DeleteStudent1() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteStudent1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteStudent1().setVisible(true);
            }
        });
    }
